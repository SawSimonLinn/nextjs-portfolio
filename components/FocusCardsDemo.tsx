...
export function FocusCardsDemo() {
  const cards = [
    ...
    },
    {
      ...
      url: 'https://example.com/sala-behta-hi-jayega',
    },
    {
      title: 'Camping is for pros',
      src: 'https://images.unsplash.com/photo-1486915309851-b0cc1f8a0084?q=80&w=3387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      url: 'https://example.com/camping-is-for-pros',
    },
    {
      title: 'The road not taken',
      src: 'https://images.unsplash.com/photo-1507041957456-9c397ce39c97?q=80&w=3456&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      url: 'https://example.com/the-road-not-taken',
    },
    {
      title: 'The First Rule',
      src: 'https://assets.aceternity.com/the-first-rule.png',
      url: 'https://example.com/the-first-rule',
    },
  ];
  ...
  return (
    <>
      <div
        id='projects'
        className='max-w-7xl mx-auto flex flex-col items-center py-20 px-4 md:px-8 lg:px-10'
      >
